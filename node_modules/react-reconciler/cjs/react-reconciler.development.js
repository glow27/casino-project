    ...
    case SuspenseListComponent:
      {
        ...
        if (renderedTail === null) {
          ...
          if (!didSuspendAlready) {
            ...
            // the expiration.
            now$1() * 2 - renderState.renderingStartTime > renderState.tailExpiration && renderLanes !== OffscreenLane) {
    ...
    case RootSuspendedWithDelay:
      {
        ...
        !shouldForceFlushFallbacksInDEV()) {
          ...
          if (workInProgressRootLatestSuspenseTimeout !== NoTimestamp) {
            ...
            _msUntilTimeout = workInProgressRootLatestSuspenseTimeout - now$1();
