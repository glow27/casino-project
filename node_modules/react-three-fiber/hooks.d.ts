...
export declare function useLoader<T>(Proto: new () => LoaderResult<T>, url: T extends any[] ? string[] : string, extensions?: Extensions, onProgress?: (event: ProgressEvent<EventTarget>) => void): T;
export {};
